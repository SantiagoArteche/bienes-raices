...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    ...
    $query = "INSERT INTO estates (title, price, img, description, wc, rooms, parking, createdAt, sellers_id) VALUES ('$title', '$price', '$imgName', '$description', '$wc', '$rooms', '$parking', '$createdAt', '$sellers_id');";
...
<main class="flex flex-col gap-5 items-center">
    <h1 class="text-6xl my-5">Crear Propiedad</h1>
...
?></div>
    ...
    <form id="admin" method="POST" action="../../admin/propiedades/crear.php" class="flex flex-col gap-5 min-w-[400px] lg:min-w-[800px]" enctype="multipart/form-data">
        ...
        <input type="submit" value="Crear Propiedad" class="font-bold bg-green-500 p-4 text-white rounded min-w-[400px] max-w-[700px] text-center">
        </div>
    </form>
